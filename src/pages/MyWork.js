		...
		return (
			<div className="container-md my-3">
				<div className="row">
					...
					<WorkItem title="Let's Find Space" link="letsfindspace" githubLink="https://github.com/Garciat427/LetsFindSpace" imageSource="images/letsfindspace1.jpg" description="A solution for optimizing the best meeting spot among people" tooltipPlacement="left" tooltipTitle="This was taken during Hack the Valley 4, a hackathon hosted at U of T Scarborough every February" />
